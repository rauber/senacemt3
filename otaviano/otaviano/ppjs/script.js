...
function olaMundo() {
  ...
  function idadeDigitada() {
    ...
    const idadePessoa = parseInt(idadeInput.value);
    const minhaIdade = 17;
    const idadeTotal = minhaIdade + idadePessoa;
    document.getElementById("mostrar").innerHTML = "Sua idade somada à minha é: " + idadeTotal;
}
